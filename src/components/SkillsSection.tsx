      ...
      <div className="container max-w-4xl mx-auto px-6 md:px-4">
        ...
        >
          <motion.div variants={skillCategoryVariants}>
            <GlassCard className="p-4">
              <h3 className="text-lg font-medium mb-3 text-center md:text-left flex items-center">
                <span className="mr-2 text-xl">💻</span> Cloud & Infrastructure
              </h3>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                {skills.cloudAndInfrastructure.map((skill, index) => (
          ...
          <motion.div variants={skillCategoryVariants}>
            <GlassCard className="p-4">
              <h3 className="text-lg font-medium mb-3 text-center md:text-left flex items-center">
                <span className="mr-2 text-xl">🗄️</span> Monitoring et CI/CD
              </h3>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                {skills.monitoringAndCICD.map((skill, index) => (
                  <SkillTag key={skill} skill={skill} index={index} />
                ))}
              </div>
            </GlassCard>
          ...
          <motion.div variants={skillCategoryVariants}>
            <GlassCard className="p-4">
              <h3 className="text-lg font-medium mb-3 text-center md:text-left flex items-center">
                <span className="mr-2 text-xl">☁️</span> Langage et Frameworks
              </h3>
              <div className="flex flex-wrap gap-2 justify-center md:justify-start">
                {skills.langageAndFrameworks.map((skill, index) => (
                  <SkillTag key={skill} skill={skill} index={index} />
                ))}
              </div>
            </GlassCard>
