export const personalInfo = {
  name: "Najibe Jean Jacques O.",
  location: "Saint Cyr l'Ecole 78210",
  email: "najibe252@gmail.com",
  linkedin:
    "https://www.linkedin.com/in/ouedraogo-najibe-jean-jacques-9a7a4a14a",
...
export const education = [
  {
    institution:
      "Université Paris Saclay, DataScale Gestion de données et Extraction de connaissances à large échelle",
...
export const skills = {
  ...
  containerizationAndOrchestration: ["Docker", "DockerCompose", "Kubernetes"],
  ...
  AgileMethodologiesCommunication: [
    "Scrum",
    "Kanban",
    "Jira",
    "Confluence",
...
export const projects = [
  ...
  },
  {
    ...
    description: [
      "Script Python POO (Programmation orientée objet) pour l’inventaire et le reporting des ressources AWS, incluant IAM, S3, EC2 et autres services clés, pour un suivi automatisé des coûts et une meilleure visibilité sur l’utilisation des ressources cloud.",
